...
//        add("CompletedMissions");
    ...
    Dictionary<String, HomeData> HomeCacheData = new Dictionary();
...
//    }
    ...
    public void reloadPlayerRanks(bool force) {
        ...
        try {
            ...
            e.printStackTrace();
            Console.WriteLine("Error tring to UPDATE player RANKS for FACTION " + getName() + "! Please report Error 'E21112D t'o an admin");
        }
    }
    ...
    public Dictionary<String, Object> GetAllSettings() {
        ...
        if (SettingCC.needsUpdate()) {
            ...
            Dictionary<String, Object> a = new Dictionary<>();
            try {
...
//                Leader = (pn);
    ...
    public void updatePlayerRankinDB(String n, FactionRank rr) {
        ...
        try {
            ...
            e.printStackTrace();
            Console.WriteLine("Error sending plots to DB FOR RANK UPDATE!!! Please report Error 'E190 t'o an admin");
        }
    }

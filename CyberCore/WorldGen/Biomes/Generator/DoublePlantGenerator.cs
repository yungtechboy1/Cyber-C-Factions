...
{
    public class DoublePlantGenerator : StructureGenerartor
    {
        ...
        {
            //"", "syringa", "", "", "", ""
            {new DoublePlant(){DoublePlantType = "fern"}, 10},
            {new DoublePlant(){DoublePlantType = "syringa"}, 10},
            {new DoublePlant(){DoublePlantType = "sunflower"}, 10},
            {new DoublePlant(){DoublePlantType = "paeonia"}, 10},
            {new DoublePlant(){DoublePlantType = "rose"}, 10},
            {new DoublePlant(){DoublePlantType = "grass"}, 10},
        };


        public DoublePlantGenerator(ChunkColumn c) : base(c)
        {
        }

...
//
//         public CyberExperimentalWorldProvider(int seed, string levelDirectory = null)
//         {
//             Seed = seed;
//             if (levelDirectory == null)levelDirectory = Config.GetProperty("PCWorldFolder", "CyberWorld");
...
//         public ChunkColumn GenerateChunkColumn(ChunkCoordinates chunkCoordinates)
//         {
//             return GenerateChunkColumn(chunkCoordinates, false);
//         }
...
//         }
//
//         public async Task<ChunkColumn> SmoothChunk(CyberExperimentalWorldProvider CyberExperimentalWorldProvider,
//             ChunkColumn chunk,
//             float[] rth, AdvancedBiome b)
//         {
//             var a = await b.preSmooth(CyberExperimentalWorldProvider, chunk, rth);
//             return a;
//         }
//
//         public async Task<ChunkColumn> PopulateChunk(CyberExperimentalWorldProvider CyberExperimentalWorldProvider,
//             ChunkColumn chunk,
//             float[] rth, AdvancedBiome b)
//         {
//             // var b = new MainBiome();
//             var a = await b.prePopulate(CyberExperimentalWorldProvider, chunk, rth);
//             return a;
...
//             var s = new Stopwatch();
//             s.Start();
//             var a = await GenerateSurfaceItems(CyberExperimentalWorldProvider, chunk, rth);
//             s.Stop();
...
//             var b = BiomeManager.GetBiome(chunk);
//             // var b = new MainBiome();
//             var a = await b.GenerateSurfaceItems(CyberExperimentalWorldProvider, chunk, rth);
//             return a;
//             // b.PopulateChunk(chunk, rain, temp);
//
// // Console.WriteLine($"GENERATORED YO BITCH >> {chunk.X} {chunk.Z}");

...
{
	public class CyberTechServerManager : IServerManager
	{
		private readonly MiNetServer _miNetServer;
		private IServer _getServer;

		protected CyberTechServerManager()
		{
		}

		public CyberTechServerManager(MiNetServer miNetServer)
		{
			_miNetServer = miNetServer;
			_getServer = new CyberTechServer(miNetServer);
		}

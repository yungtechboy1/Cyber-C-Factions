...
{
	public class CyberPlayerFactory : PlayerFactory
	{
		public CyberPlayer CreatePlayerCyberPlayer(MiNetServer server, IPEndPoint endPoint, PlayerInfo playerInfo)
		{
			CyberPlayer player = new CyberPlayer(server, endPoint)
			{

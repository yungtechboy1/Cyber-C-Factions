 ...
 */
public class Top : Commands {

    public Top(CommandSender s, String[] a, Faction_main m){
        base(s,a,"/f Top",m);
    ...
    public new void RunCommand() {
        String s = "";
        s = s + ChatColors.YELLOW+"-------{[Faction Top]}-------\n";
        int x = 0;
    ...
    private Dictionary<int,String> GetTopFacs(int i){
        ...
        for(java.util.Map.Entry<String,int> a : Main.FF.Top.entrySet()){
